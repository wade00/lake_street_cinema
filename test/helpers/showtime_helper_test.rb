...
class ShowtimeHelperTest < ActionView::TestCase
  ...
  test "start time should be converted into strftime with day" do
  ...
  test "start time should be converted into strftime without day" do
    showtime1 = Showtime.new(start_time: "2015-07-19 11:00:00")
    assert_equal "11:00am", format_showtime_without_day(showtime1)

    showtime2 = Showtime.new(start_time: "2015-07-19 13:00")
    assert_equal "1:00pm", format_showtime_without_day(showtime2)
  end
